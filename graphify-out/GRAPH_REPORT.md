...
## Corpus Check
- 11 files · ~102,431 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 118 nodes · 199 edges · 14 communities (10 shown, 4 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 3 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6504ff24`
...
Cohesion: 0.16
Nodes (20): bindAdd(), bindBrowse(), bindLangSheet(), bindNav(), bindSettingsSheet(), boot(), _browse, formatBytes() (+12 more)
...
## Knowledge Gaps
- **43 isolated node(s):** `_browse`, `_hapticCtx`, `ASSETS`, `Features`, `Project Structure` (+38 more)
...
- **What connects `_browse`, `_hapticCtx`, `ASSETS` to the rest of the system?**
  _43 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Browse & SRS Status UI` be split into smaller, more focused modules?**
